...
/* Animate a number from 0 -> target once element is in view */
...
/* Reveal wrapper component (adds .in when scrolled into view) */
...
/* Heart toggle button (stops card click) */
function HeartButton({ id, dark = false, size = 18 }) {
...
Object.assign(window, { useCountUp, useInView, Reveal, useTilt, useFavorites, favStore, HeartButton, ScrollProgress });
