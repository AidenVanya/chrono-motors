...
function CarPhotoCard({ car, t, lang, openCar, idx = 0 }) {
  return (
...
function Showroom({ t, lang, openCar }) {
  ...
  return (
    <div className="page-enter min-h-screen bg-bg pt-28 pb-24">
      <div className="max-w-[1240px] mx-auto px-6">
        ...
        {/* grid — keyed by cat so cards re-mount + replay animation */}
...
Object.assign(window, { Showroom, CarPhotoCard, SpecPill });
